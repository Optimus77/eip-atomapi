...
public class QosService {
    ...
    public static void main(String[] args) {
        QosService qs = new QosService("10.110.29.206", "443", "hillstone", "hillstone");
        HashMap<String, String> map = new HashMap();
        map.put("pipeName", "lhltest");
        map.put("ip", "10.110.29.206");
        map.put("serviceNamne", "Any");
        map.put("serNetCardName", "ethernet0/1");
        map.put("bandWidth", "100");
        qs.updateQosPipe("1545322566250645344", "lhltest", "10");
