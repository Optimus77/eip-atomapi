...
public class QosService {
     ...
     * @return ret
     */
    HashMap<String, String> addIpTosharedQos(String fip, String pipId,String sbwId) {
        HashMap<String, String> res = new HashMap();
